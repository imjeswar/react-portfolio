...
import ProjectDetailsFitzone from "./components/ProjectDetailsFitzone";
    ...
    <>
      ...
      <div className="relative text-amber-100 space-y-20 pb-20">
        ...
        <div className="max-w-5xl mx-auto space-y-12 md:space-y-20 px-2 md:px-4 shadow-none">
          ...
          <Skills />
          <Projects />
          {/* Alternating Layout Verification: L, R, L, R, L, R, L */}
          ...
          <ProjectDetailsFitzone />                               {/* L */}
          <ProjectDetailsChatbot handleReload={handleReload} />   {/* R */}
          <ProjectDetailsHealth handleReload={handleReload} />    {/* L */}
          <Certifications />
          <Contact />
        </div>
        <Footer />
