    ...
    <div className="flex flex-col md:flex-row items-center gap-10 premium-glass animate-glow p-6 md:p-12 rounded-3xl shadow-lg hover:shadow-[0_0_25px_rgba(251,191,36,0.6)] transition duration-300">
      ...
      <div className="w-full md:w-1/2 flex justify-center mb-8 md:mb-0">
        <img
          ...
          alt="FITZONE Gym Management Platform"
        />
      </div>
      ...
      <div className="md:w-1/2 text-center md:text-left">
        ...
        <p className="text-gray-300 mb-6 leading-relaxed">
          A modern solution designed to simplify day-to-day gym operations. Instead of managing members, attendance, payments, and memberships across spreadsheets and WhatsApp chats, FITZONE offers a complete, centralized dashboard.
        </p>
...
export default ProjectDetailsFitzone;
