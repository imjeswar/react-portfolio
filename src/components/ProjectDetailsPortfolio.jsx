...
const ProjectDetailsPortfolio = ({ handleReload }) => (
  <section id="project1-details" className="py-16 bg-black scroll-mt-20">
    <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10 bg-gray-900 p-6 rounded-lg border border-amber-300 shadow-lg hover:shadow-[0_0_25px_rgba(251,191,36,0.6)] transition duration-300">
      {/* Image (Left) */}
